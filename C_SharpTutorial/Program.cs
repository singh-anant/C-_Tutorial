...
class Solution
{
    static void Main()
    {
        ...
        //===============================================
        //  new Casting().castingTutorial

        new Employee(101, "Naruto Uzumaki", "Backend Developer").printEmployeeDeatils();
        new Employee(102, "Johaan Libert", "Frontend Developer").printEmployeeDeatils();
        new Employee(103, "Ayanokoji", "Software QA").printEmployeeDeatils();
        System.Console.WriteLine(Employee.companyName);

        //now lets say we want a construtor to initialzide from main class we can use object initializer..
        Employee em = new Employee() { empName = "Ryu", empRole = "Power Bi Developer" };
